const {Crop, Wheat, Sugarcane, Farm} = require("./crops")

//testing Crop parent class
test('A crop can store its area size', () => {
    const crop = new Crop(12345)
    expect(crop.acres).toBe(12345)
  })

//testing Wheat class with getYieldInKg
...
//testing Sugarcane class with getYieldInKg
